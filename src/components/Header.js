...
const Header = () => {
  ...
  return (
    <div className="flex m-4 justify-between shadow-2xl p-2">
      ...
      <input type="text"  placeholder="search" className="w-[500px] p-2 border-2 rounded-l-full"></input>
        <button className="px-4 p-2.5 w-14 rounded-r-full bg-slate-200">🔍</button>
